      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {MenusData.map((menu)=>(
          < motion.div
            ...
            style={props.Off?{backgroundColor:" rgba(30, 30, 30, 1)"}:{backgroundColor:"white"}}
           className="rounded-3xl px-4 py-2
          shadow-[0_0_22px_0_rgba(0,0,0,0.15)] flex flex-row
          justify-around items-center gap-1">
         
           <img src={menu.img} alt="" className="w-[60px]
           mb-4 scale-110 transform-translate-y-6 "></img>
        <div>
           <h1 className="taxt-lg font-semibold">{menu.title}</h1>
